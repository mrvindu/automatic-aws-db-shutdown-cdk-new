...
export class PipelineStack extends Stack {
    constructor(scope: Construct, id: string, props: PipelineStackProps) {
        ...
        const githubRepo = StringParameter.valueFromLookup(this, "/automatic-aws-db-shutdown-cdk-new/github/repo");
        const githubOwner = StringParameter.valueFromLookup(this, "/automatic-aws-db-shutdown-cdk-new/github/owner");
